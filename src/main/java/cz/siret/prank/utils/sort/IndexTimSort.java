...
/**
 * Modified version of TimSort from java.util.
...
class IndexTimSort<T> {
     ...
     */
    private IndexTimSort(int[] a, IntComparator c, int[] work, int workBase, int workLen) {
        this.a = a;
        this.c = c;
    ...
    static void sort(int[] a, int lo, int hi, IntComparator c,
         ...
         */
        IndexTimSort ts = new IndexTimSort(a, c, work, workBase, workLen);
     ...
     *          the specified array
     */
    private static <T> int countRunAndMakeAscending(int[] a, int lo, int hi,
                                                    IntComparator c) {
        assert lo < hi;
        int runHi = lo + 1;
        if (runHi == hi)
